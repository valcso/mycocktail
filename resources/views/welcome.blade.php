              ...
              <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img  src="images/cock.png"  width="50%">
                  </div>
                  <div class="carousel-item">
                    <img  src="images/3884-removebg-preview.png" width="50%">
                  </div>
                  <div class="carousel-item">
                   <img  src="images/co3.png"  width="50%">
                  </div>
                </div>
                ...
                <div class='col-xl-5 col-lg-5 col-md-5 col-sm-12 col-xs-12 shadow-md' id='welcomeDivRight'>
                   ...
                   <h6 id='title'>&#128077 Write opinion and see what others said about drink.</h6><br>
